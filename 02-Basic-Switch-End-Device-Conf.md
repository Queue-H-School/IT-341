...
<u>Security</u></br>
`# hostname *new-hostname*` changes the hostname to "new\-hostname"</br>
...
`# banner motd *message*` sets security banner message to message (requires start and end chars)</br>
